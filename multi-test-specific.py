"""
Multitask testing with shared layers from one specific dataset
"""

import dan2_multi_specific as dan2
import numpy as np
import pickle
import sys
...
if __name__ == '__main__':
    ...
    f_k, mse, clf = main(X_train, X_test, y_train_3 ,y_test_3, 30)
    print(f_k, 'is f_k')
    print('X_train', X_train)
    print('y_train_2',y_train_2)
    # print ('-'*50, X_train, '-'*50, y_train_1, '-'*50, f_k, clf)
    mse_1, fk_1 = multi(X_train, y_train_1, 20, 0, f_k, clf)
